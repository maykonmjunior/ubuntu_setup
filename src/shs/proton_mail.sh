...
install_deb() {
    ...
    sudo apt-get install -fy  # Instalar dependências faltantes, se houver
}
...
uninstall_app() {
    ...
    sudo apt-get autopurge -fy  # Remover dependências não mais necessárias
}
